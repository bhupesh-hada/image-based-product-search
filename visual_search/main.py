...
def main(args: argparse.Namespace) -> None:
    ...
    if config["neptune_logger"]:
        neptune_logger = NeptuneLogger(
            api_key='eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vdWkubmVwdHVuZS5haSIsImFwaV91cmwiOiJodHRwczovL3VpLm5lcHR1bmUuYWkiLCJhcGlfa2V5IjoiM2EzODMzNWEtMTc5YS00OWE2LTg1ZTYtNGE5MDQwMjE5ZDI0In0=',
            project="aicrowd-vs",
            name=args.name,
        ...
        run_neptune = neptune_logger.run
        run_neptune["config"].upload(args.cfg)
