...
def get_dataloaders(config):                                                                         # Function for creating training and validation dataloaders
    
    
    print("Preparing train reader...")
    train_dataset = dataset.Product10KDataset(                                                       # using the Product10KDataset function to tranform the data and perform data augmentation 
