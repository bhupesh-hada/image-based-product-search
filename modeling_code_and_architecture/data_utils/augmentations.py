...
def get_train_aug(config):                                                           # resizing and augmenting the training dataset
...
def get_val_aug_query(input_size: int):                                                         # resizing and augmenting the query images which are part of the test daatset
...
def get_val_aug_gallery(input_size: int):                                                     # resizing and augmenting the gallery images which are part of the test daatset
    val_augs = tv.transforms.Compose([
